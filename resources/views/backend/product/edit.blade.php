                        ...
                        <form action="{{ route('admin.product.update', $product->id) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="{{ asset($product->multiple_image) }}" width="40" alt="multiple_image">
                                </div>
                                <div class="form-group">
                                    <label for="price">product price</label>
                                    <input type="number" name="price" value="{{ old('price', $product->price) }}" class="form-control" placeholder="Enter your product price">
                                </div>
                                <div class="form-group">
                                    <label for="discount">product Discount [optional]</label>
                                    <input type="number" name="discount" value="{{ old('discount', $product->discount) }}" class="form-control" placeholder="Enter your product discount">
                                </div>
                                <div class="form-group">
