                            ...
                            <div class="col-lg-7">
                                ...
                                <ul class="navbar-nav header__right float-lg-end flex-wrap justify-content-center">
                                    <li class="nav-item dropdown">
                                        <a class="dropdown-toggle nav-link" href="#" role="button" id="drp1" data-bs-toggle="dropdown" aria-expanded="false">
                                            USD
                                        </a>
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="dropdown-toggle nav-link" href="#" role="button" id="drp2" data-bs-toggle="dropdown" aria-expanded="false">
                                            English
                                        </a>
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="#"><i class="far fa-user-circle"></i> <span>My Account</span></a></li>
                                    <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-shopping-bag"></i> <span>My Card</span></a></li>
                                    <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-sign-in-alt"></i> <span>Login</span></a></li>
                                </ul>
                        ...
                        <div class="row position-relative">
                            ...
                            <div id="search" class="mobile__search__bar d-lg-none position-absolute">
                                <form class="d-flex search__area">
                                    ...
                                    <button class="search__btn" type="submit"><i class="fas fa-search"></i></button>
                                    <!-- close btn -->
                                    <a onclick="searchCloseBtn()" href="javascript:;" class="border-0 bg-transparent close__btn"><i class="las la-times"></i></a>
                                </form>
                            </div>
                                ...
                                <ul class="utility">
                                    ...
                                    <li><a href="javascript:;">
                                        ...
                                        <div class="product__list p-4">
                                            ...
                                            <a class="btn btn-primary rounded-0 shadow d-block mt-3" href="#">CHECKOUT</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
